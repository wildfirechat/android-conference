...
| [ios-conference](https://github.com/wildfirechat/ios-conference)                 | N/A                 | 野火会议iOS客户端 |                                                |  |
| [android-conference](https://github.com/wildfirechat/android-conference)                 | N/A                 | 野火会议Android客户端 |                                                |  |


## 说明

野火会议iOS客户端源码。可以直接运行野火会议，可以[申请试用](https://docs.wildfirechat.cn/trial/)或者购买够搭建在自己的服务器上。音视频会议的背景知识请参考[《野火音视频高级版的一些知识》](https://docs.wildfirechat.cn/blogs/野火音视频高级版的一些知识.html)
